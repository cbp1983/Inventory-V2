...
/**
 * Content Provider for the book inventory app.
 */
...
public class BookProvider extends ContentProvider {
    ...
    /**
     * URI matcher code for the content URI for the entire book inventory table
     */
    ...
    /**
     * Insert a new book into the database with the given content values. Return the new content
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        if (supplier == null) {
            throw new IllegalArgumentException("Book supplier required");
        }
        ...
        // If the ID is -1, then the insertion failed, so log an error and return null.
        if (id == -1) {
            Log.e(LOG_TAG, "Failed to insert the book for " + uri);
            return null;
        }

        // Notify that the data has changed for the book content URI
        getContext().getContentResolver().notifyChange(uri, null);

        // Return the new URI with the ID of the newly inserted row, at the end
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the name key is present, make sure it's not null
        ...
        // If the price key is present, make sure it's not null
        ...
        // If the quantity  key is present, make sure it's not null
        ...
        // If the supplier key is present, make sure it's not null
        ...
        // If the phone number key is present, make sure it's not null
        ...
        // If there are no values to update, don't bother trying
        if (values.size() == 0) {
            return 0;
        }
        ...
        // If 1 or more rows were updated, notify listeners that the data at the URI has changed
        if (rowsUpdated != 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // If rows were deleted, notify listeners that the data at the URI has changed
        if (rowsDeleted != 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
